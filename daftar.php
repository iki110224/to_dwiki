            ...
            <div class="col-5">
               <div class="card">
                <div class="card-body">
                    ...
                    <p class="card-tilte">Daftar Akun</p>
                    <?php
                    ...
                    if ($submit=='Daftar'){
                       ...
                       $alamat=@$_POST['alamat'];
                       //cek jika ada username dan email yang sama
                       //jika ada yang sama maka daftar akan gagal karna username atau email sudah dipakai orang lain
